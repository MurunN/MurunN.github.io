...
const gameCopy = {
  mn: {
    ...
    guest: "Google-оор нэвтэрвэл таны оноо, XP болон нээсэн тэмдэг ‘Миний аялал’ хэсэгт хадгалагдана.",
  ...
  en: {
    ...
    guest: "Sign in with Google to save your score, XP and unlocked badges to your profile.",
